describe("Appointments", () => {
  ...
  xit("should edit an interview", () => {
    ...
    cy.get("[data-testid=student-name-input]").clear().type("AHK");
    cy.get("[alt='Tori Malcolm']").click();
    // 4. Clicks the save button
    cy.contains("Save").click();
    // 5. Sees the edit to the appointment
    cy.contains(".appointment__card--show", "AHK");
  ...
  it("should cancel an interview", () => {
    ...
    // 4. Sees that the deleting status exists, does not exist and then the appointment slot is empty  
